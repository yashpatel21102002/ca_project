            ...
            <div className="w-full bg-light max-lg:h-auto h-[120px] flex flex-col gap-5 items-center text-dark-green pb-2">
                ...
                <div className="grid gap-7 grid-cols-9 max-lg:grid-cols-4 max-md:grid-cols-3">
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <BsTwitter />
                        <span className='text-sm font-thin'>Twitter</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <AiOutlineGithub />
                        <span className='text-sm font-thin'>Github</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <AiFillMediumSquare />
                        <span className='text-sm font-thin'>Medium</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <AiFillLinkedin />
                        <span className='text-sm font-thin'>Linkedin</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <AiFillInstagram />
                        <span className='text-sm font-thin'>Instagram</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <SiCodechef
                         />
                        <span className='text-sm font-thin'>Codechef</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <SiCodeforces />
                        <span className='text-sm font-thin'>Codeforces</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <SiLeetcode />
                        <span className='text-sm font-thin'>Leetcode</span>

                    </div>
                    <div className="flex flex-col justify-center items-center text-3xl cursor-pointer hover:text-dark-green ">
                        <RxVercelLogo />
                        <span className='text-sm font-thin'>Vercel</span>
